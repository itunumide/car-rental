...
const ServicePricing = (props) => {
    return (
      <div className="flex items-center md:items-start justify-center flex-col font-light">
        ...
        <p className='text-[#a3a198] text-[1.05rem] font-normal italic mt-10 w-full md:w-[70%] leading-8 mb-12'>Car Rental is a leader in online car rental reservations; we compare car rental deals from many companies so that you can choose which is best for your trip.</p>
