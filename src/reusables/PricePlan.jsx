...
const PricePlan = () => {
  return (
    <div>
        <div className="outer h-[35rem] w-[18rem] md:w-[20rem] bg-[#FFCA08] rounded-[1.5rem] flex flex-col items-center justify-start relative z-10">
            ...
            <div className="inner w-[95%] m-auto h-[85%] bg-[#1C1601] rounded-[1.5rem] relative top-[0.85rem] rounded-t-[30%]">
                <ul className="text-white relative top-16 left-12 md:left-16 space-y-6 italic font-medium">
