const Service = (props) => {
  return (
    <div className="flex items-center justify-center mt-[8rem] md:mt-[4rem] flex-col font-light">
      <p className="py-1 px-3 md:px-12 rounded-3xl text-[0.7rem] md:text-[1.5rem] italic mb-4" style={{backgroundColor: `${props.titlebg}`, color: `${props.titlecolor}`}}>{props.title}</p>
      <p
