...
const TestimonialService = (props) => {
    return (
      <div className="flex justify-center flex-col font-light">
        <p className="py-2 md:text-left text-center w-full md:w-[60%] px-3 md:px-12 rounded-3xl text-[0.9rem] md:text-[1.3rem] italic mb-8" style={{backgroundColor: `${props.titlebg}`, color: `${props.titlecolor}`}}>{props.title}</p>
        <p
