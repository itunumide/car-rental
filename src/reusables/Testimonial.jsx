...
const Testimonial = () => {
  return (
    <div className="flex flex-col md:flex-row justify-between gap-16 w-4/5 m-auto">
        <div className="left w-[90%] md:w-[50%] px-4">
            <TestimonialService
            titlebg = "#F1F1F1"
            titlecolor = "#575757"
        ...
        <div className="right w-[90%] md:w-[45%] flex flex-col">
