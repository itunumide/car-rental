  ...
  return (
    <div className="fixed inset-0 bg-gray-800 bg-opacity-50 backdrop-filter backdrop-blur-sm flex justify-center items-center z-50 text-center">
      <div className="bg-white p-6 rounded-lg shadow-xl max-w-md w-full">
        ...
        <div className="flex justify-center mb-6">
          ...
          <div className="relative">
            ...
            <div className="relative w-8 h-8 top-2 left-2 bg-custom-yellow-100 rounded-full flex items-center justify-center ">
              <svg className="h-4 w-4 text-custom-yellow-500" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.879px" height="88.855px" viewBox="0 0 122.879 88.855" enable-background="new 0 0 122.879 88.855" xml:space="preserve">
        ...
        <button onClick={handleSignIn} className="mb-2 w-full bg-custom-yellow-500 py-2 rounded-lg">
          Sign In
        </button>
