...
return (
  <div className="flex flex-col items-center justify-center min-h-screen p-6 bg-white">
    <div className="relative bg-gradient-to-r from-white to-custom-yellow-300 px-8 py-16 rounded-lg shadow-lg w-full max-w-lg text-center">
      <div className="bg-white p-8 rounded-lg shadow-lg">
        <div className='flex items-center justify-center pb-2'>
          <svg className="h-8 w-8 text-custom-yellow-400" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" x="0px" y="0px" width="122.879px" height="88.855px" viewBox="0 0 122.879 88.855" enableBackground="new 0 0 122.879 88.855" xmlSpace="preserve">
