    ...
    <div>
      ...
      <div className="hidden">
        ...
        <div className="grid grid-cols-2 gap-2 md:flex lg:flex my-10 lg:gap-2 px-5 w-10/12 justify-around">
          <div className="border-none flex flex-col w-auto text-center rounded-lg border-slate-800">
            <img id="cart-img" className="h-64 border-4 rounded-t-lg border-green-950 " src={car3}alt="" />
            <a className="text-xl font-bold w-full rounded-b-lg text-amber-300  bg-green-950" href="">
              <h4 className="py-4 rounded-b-lg hover:bg-amber-400 hover:text-black duration-300  bg-green-950"> <i className="ri-shopping-cart-2-line"></i>Add to cart</h4>
              {/* <h4 className="invisible -mt-10 bg-white rounded-3xl hover:-mt-28 hover:visible hover:bg-black">
