...
import StepNavigation from "../reusables/StepNavigation";
...
const Rent = () => {
  ...
  return (
    <>
      <PagesHero />
      <div className="mt-8 w-[90vw]  m-auto">
        <div className="top flex flex-col gap-4 sm:flex-row sm:justify-between">
          ...
          <div className="right sm:w-[80%] flex justify-start sm:justify-end gap-4">
            ...
            <select
              className="rounded-3xl px-2 bg-white border-2 border-[#dedede]"
              value={itemsPerPage}
            ...
            {/* Sorting Dropdown */}
            <select
              className="rounded-3xl p-2 bg-white border-2 border-[#dedede]"
              value={sortBy}
        ...
        <div className="body mt-8 grid w-full grid-cols-1 gap-10 sm:grid-cols-2 md:grid-cols-3 2xl:grid-cols-4">
          {/* Render cars */}
        ...
        {/* Pagination Controls */}
        <div className="w-full flex justify-center mt-16"><StepNavigation itemsPerPage={itemsPerPage} totalCars={cars.length} currentPage={currentPage} setCurrentPage={setCurrentPage} />
        </div>
      </div>
    </>
  );
